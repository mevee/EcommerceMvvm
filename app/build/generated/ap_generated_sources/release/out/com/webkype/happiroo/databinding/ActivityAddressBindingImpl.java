...
public class ActivityAddressBindingImpl extends ActivityAddressBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.addressHeaderCard, 1);
        sViewsWithIds.put(R.id.backAddress, 2);
        sViewsWithIds.put(R.id.main_address_layout, 3);
        sViewsWithIds.put(R.id.addNewAddressRelative, 4);
        sViewsWithIds.put(R.id.rv_address_list, 5);
        sViewsWithIds.put(R.id.progressbar_address, 6);
    }
    // views
    @NonNull
