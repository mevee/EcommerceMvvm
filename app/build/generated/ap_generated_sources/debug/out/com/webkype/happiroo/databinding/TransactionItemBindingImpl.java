...
public class TransactionItemBindingImpl extends TransactionItemBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.transType_tV, 1);
        sViewsWithIds.put(R.id.transactionId, 2);
        sViewsWithIds.put(R.id.dateTimeWallet_tV, 3);
        sViewsWithIds.put(R.id.creditOrDebitAmt_tV, 4);
    }
    // views
    @NonNull
